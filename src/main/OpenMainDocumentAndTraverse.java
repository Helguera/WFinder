...
public class OpenMainDocumentAndTraverse extends AbstractSample {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
                ...
                String type1 = "org.docx4j.wml.Text";
                String type2 = "org.docx4j.wml.Text";
                String temp = "";

		try {
			getInputFilePath(args);
		} catch (IllegalArgumentException e) {
			inputfilepath = "C:\\Users\\Sociograph\\Desktop\\prueba.docx";
		}
		...
		new Callback() {
			...
			public List<Object> apply(Object o) {
				...
				//System.out.println(indent + o.getClass().getName() + wrapped + "  \"" + text + "\"");
                                
                                /*if (o.getClass().getName().equals("org.docx4j.wml.Text")){
                                    System.out.println(text + " ------- mi clase es: "+ o.getClass().getName());
                                }else{
                                    System.out.println(text + "No soy texto" + " ------- mi clase es: "+ o.getClass().getName());
                                }*/
